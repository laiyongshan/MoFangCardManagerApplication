...
//        if (mtools.getishadLogin()){ //  已经登录的情况下多显示预报预警界面
        mTabBar.mTextVTitleArray = new String[]{"首页", "对比", "地图", "排名"};
        mTabBar.mSelectImageVIconArray = new int[]{R.mipmap.icon_home_active, R.mipmap.icon_duibi_active, R.mipmap.icon_map_active, R.mipmap.icon_paiming_active, R.mipmap.icon_warn_active, R.mipmap.icon_calendar_active};
        mTabBar.mUnSelectImageVIconArray = new int[]{R.mipmap.icon_home, R.mipmap.icon_duibi, R.mipmap.icon_map, R.mipmap.icon_paiming, R.mipmap.icon_warn, R.mipmap.icon_calendar};
//        mTabBar.mTabFragmentClassArray = new Class<?>[]{HomeFagment.class, CompareFragment.class, MapFragment.class, ListFragment.class, ForecastWaringFragment.class, CalendarAndCountFragment.class};
//        }else{
